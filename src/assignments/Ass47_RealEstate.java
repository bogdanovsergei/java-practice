...
public class Ass47_RealEstate {
	public static void main(String[] args) {
		...
		if (houseType.contentEquals("Condo")) {
			propertyPrice = propertyPrice + 50000;
		} else if (houseType.contentEquals("Townhouse")) {
			propertyPrice = propertyPrice + 75000;
		} else if (houseType.contentEquals("Single Family Home")) {
